...
//        System.out.println(sum2);
    ...
    public void testForExample3() {
        ...
        *  1부터 발생한 난수까지의 합계를 구해보자 */
        ...
        System.out.println("1부터 " + randN + "까지의 합은 : " + sum );

        int sum2 = 0;
        for (int i = 1; i <= randN; i++) {
            sum2 += i;
        }
        System.out.println("1부터 " + randN + "까지의 합은 : " + sum2 );
    ...
    public void testForExample4() {
        ...
        *  그렇지 않은 경우 "반드시 2 ~ 9 사이의 양수를 입력해야 합니다" 출력 */
        ...
        Scanner sc = new Scanner(System.in);
        System.out.print("출력할 구구단 단 수를 입력하세요 : ");
        int dan = sc.nextInt();
...
//        } else {
//            System.out.println("반드시 양수를 입력해야 합니다.");
//        }
